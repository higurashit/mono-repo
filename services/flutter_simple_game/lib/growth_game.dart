...
class GrowthGame extends StatefulWidget {
  const GrowthGame({super.key});

  @override
  _GrowthGameState createState() => _GrowthGameState();
}
...
class _GrowthGameState extends State<GrowthGame> {
  ...
  Future<void> authorize() async {
    ...
    print("activity: ${activityStatus.isGranted}");
    print("locaiton: ${locationStatus.isGranted}");
